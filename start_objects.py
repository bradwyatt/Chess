...
class StartPiecesBehind(pygame.sprite.Sprite):
    """
    Object used to be beneath the object that is being dragged onto board.
    For example, if you click on white pawn on the right of the board,
    and then drag to the board, you'll see the white pawn image on the mouse
    cursor (from StartPawn) AND the white pawn on the right of the board
    from (StartPiecesBehind)
    """
...
class Dragging():
    ...
    def dragging_to_placed_no_dups(cls, mouse_coord):
        ...
        if cls.drag_piece_name == "white_pawn":
        ...
        elif cls.drag_piece_name == "white_bishop":
            placed_objects.PlacedBishop(mouse_coord, "white")
        elif cls.drag_piece_name == "white_knight":
            placed_objects.PlacedKnight(mouse_coord, "white")
        elif cls.drag_piece_name == "white_rook":
            placed_objects.PlacedRook(mouse_coord, "white")
        elif cls.drag_piece_name == "white_queen":
            placed_objects.PlacedQueen(mouse_coord, "white")
        elif cls.drag_piece_name == "white_king":
