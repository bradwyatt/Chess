...
load_image("Sprites/pgn_savefile.png", "SPR_PGN_SAVE_FILE_BUTTON", True, True)
load_image("Sprites/pgn_loadfile.png", "SPR_PGN_LOAD_FILE_BUTTON", True, True)
load_image("Sprites/computer_icon_on.png", "SPR_AI_BUTTON_ON", True, True)
load_image("Sprites/computer_icon_off.png", "SPR_AI_BUTTON_OFF", True, True)